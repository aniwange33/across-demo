...
import com.amos.simple_modular_app.GreetingAppApplication;
...
@WebAppConfiguration
@SpringBootTest(classes = { GreetingAppApplication.class, MockMvcConfiguration.class })
@ActiveProfiles("integration-test")
@ContextConfiguration(initializers = MockAcrossServletContextInitializer.class)
public class ITGreetingAppApplication
{
	@Autowired
